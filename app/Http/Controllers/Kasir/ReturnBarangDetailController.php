...
class ReturnBarangDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.kasir.return-barang.detail-return-barang')->with('details', $details);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.kasir.return-barang.detail-barang')
                        ->with(
                            [
                                'details' => $get_details,
                                'tanggal' => $tgl_return,
    ...
    public function edit($id)
    {
        ...
        return view('pages.kasir.return-barang.ubah-return')->with(
            [
                'returns' => $edit,
                'data' => $data,
            ]
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/kasir/detail-return-barang')->with('status', 'Data Berhasil Diubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/kasir/detail-return-barang');
    }
    ...
    public function cari_return(Request $request)
    {
        if ($request->ajax()) {
            ...
            return view('pages.kasir.return-barang.pagination_data')
