...
class GudangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.gudang.daftarstok')->with(
            [
                'details' => $data,
            ]
        );
    ...
    public function create()
    {
        ...
        return view('pages.admin.gudang.tambah')->with(
            [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/gudang')->with('status', 'Data Berhasil Ditambah');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.gudang.ubah')->with(
            [
                'gudang' => $edit,
            ]
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/admin/gudang')->with('status', 'Data Berhasil Diubah');
    }
    ...
    public function cari_gudang(Request $request)
    {
        if ($request->ajax()) {
            ...
            return view('pages.admin.gudang.pagination_data')->with('details', $data)->render();
        }
    }
