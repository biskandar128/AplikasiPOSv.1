                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                               ...
                               <div class="table-responsive text-nowrap">
                                ...
                                <td><a href="{{ url('/admin/laporan-aktifitas/' . $detail->kd_aktivitas . '/detail') }}">{{ $detail->kd_aktivitas }}</a></td>
                                <td>{{ \Jenssegers\Date\Date::parse($detail->tgl_aktifitas)->locale('id')->format('l, d F Y') }}</td>
