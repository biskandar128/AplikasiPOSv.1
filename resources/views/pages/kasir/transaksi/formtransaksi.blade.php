            ...
            <div class="col-12 col-lg-12 col-xl-5">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                                ...
                                <form action="{{ url('/kasir/transaksi') }}" method="post" id="form_transaksi" name="form_transaksi" onclick="return validateForm()">
                                @csrf  
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('tgl_transaksi') is-invalid @enderror" id="tgl" name="tgl_transaksi" readonly value={{date('Y-m-d')}}>
                                                @error('tgl_transaksi')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('kd_barang') is-invalid @enderror" id="kd_barang_transaksi" name="kd_barang" autofocus></select>
                                                @error('kd_barang')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-nowrap">
                                ...
                                <a href="{{ url('/kasir/transaksi/cetak') }}" target="blank" class="btn btn-primary btn-icon-split mb-5 mt-3">
                                    <span class="icon text-white-50">
   ...
   // Js Auto Select
      $(document).ready(function(){
          $('#kd_barang_transaksi').on('change', function(e){
            ...
            $.get('{{ url('/kasir/transaksi-select') }}/'+id, function(data){
              console.log(id);
              console.log(data);
