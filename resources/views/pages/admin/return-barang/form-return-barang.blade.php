                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 mb-3">
                            <form action="{{ url('/admin/form-return-barang') }}" method="post" id="form_return">
                            @csrf
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_retur" name="no_retur" placeholder="Masukkan No Retur">
                                </div>
...
$(document).on('click', '#btn_submit_return', function(){
 ...
 // Hide and Show Form Return Barang
  $(document).ready(function(){
    ...
    $.ajax({
        type: 'get',
        url: '/admin/form-return-barang/cari',
        ...
        $(document).on("click", "#return" , function() {
            ...
            else if( return_address == '' )
            {
              Swal.fire({
                ...
                $.ajax({
                  url: '/admin/form-return-barang/return-barang/'+return_id+'/'+return_val+'/'+return_date+'/'+return_code,
                  type: 'get',
