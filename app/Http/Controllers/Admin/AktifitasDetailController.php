...
class AktifitasDetailController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.admin.aktivitas.aktivitas')
                ->with(
                    [
                        'code' => $addCode,
                        'details' => $detail,
    ...
    public function store(Request $request)
    {
        if ($request->btn_tambah == 'tambah_biaya') {
            ...
            return redirect('/admin/tambah-aktifitas')->with('status', 'Data Aktifitas Selesai Ditambahkan');
            ...
            return redirect('/admin/tambah-aktifitas')->with('status', 'Data Aktifitas Berhasil Disimpan. Terimakasih');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.admin.aktivitas.detail-aktifitas')->with(
                    [
                    'reports' => $reports,
    ...
    public function edit($aktifitas, $code)
    {
        ...
        return view('pages.admin.aktivitas.ubah-aktifitas')->with('details', $details);
    }
    ...
    public function update(Request $request, $id, $aktifitas)
    {
        ...
        return redirect('/admin/tambah-aktifitas')->with('status', 'Data berhasil diubah');
    }
    ...
    public function destroy($id, $code)
    {
        ...
        return redirect('/admin/tambah-aktifitas');
    }
}
