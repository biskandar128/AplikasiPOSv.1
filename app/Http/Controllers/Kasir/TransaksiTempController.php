...
class TransaksiTempController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.kasir.transaksi.formtransaksi')->with(
            [
                'kd_barang' => $kd_item,
    ...
    public function store(Request $request)
    {
        ...
        if ($request->transaksi == 'transaksi') {
            ...
            return redirect('/kasir/transaksi')->with('status', 'Transaksi Berhasil Dilakukan');
        }
        ...
        if ($request->transaksi_detail == 'transaksi_clear') {
            ...
            return redirect('/kasir/transaksi')->with('status', 'Transaksi sudah dibayar. Terimakasih ^_^');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.kasir.transaksi.formubah')->with(
            [
                'updates' => $transaksi,
            ]
        );
    ...
    public function cetak()
    {
        ...
        $pdf = PDF::loadView('pages.kasir.transaksi.print', ['cetak' => $cetak, 'transaksi' => $transaksi, 'total' => $total_belanja])->setPaper('A5', 'potrait');
