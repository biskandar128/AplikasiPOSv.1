...
class ReturnBarangController extends Controller
{
    ...
    {
        $automatic_code = ReturnBarang::max('kd_return');
        $maxCode = (int) substr($automatic_code, 4, 6);
        $generateCode = $maxCode + 1;
        $addCode = 'RTRN'.sprintf('%06s', $generateCode);

        return view('pages.kasir.return-barang.form-return-barang')->with('code', $addCode);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kasir/form-return-barang');
    }
