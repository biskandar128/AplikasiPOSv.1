...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ url('/admin/detail-return-barang') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><span class="fa fa-chevron-left text-white-150"></span> Kembali</a>
        </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-12 mb-3">
                                <form action="{{ url('/admin/detail-return-barang/' . $data->kd_return ) }}" method="post">
                                @method('PATCH')
                                @csrf
